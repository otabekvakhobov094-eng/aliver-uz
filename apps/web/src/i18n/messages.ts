...
export const messages = {
  uz: {
    ...
    'partner.title': 'ALIVER hamkori bo‘ling',
    'partner.subtitle': 'Ulgurji xarid, dilerlik va korporativ buyurtmalar uchun ariza qoldiring.',
    'partner.company': 'Kompaniya',
    'partner.person': 'Kontakt shaxs',
    'partner.phone': 'Telefon',
    'partner.telegram': 'Telegram',
    'partner.city': 'Shahar',
    'partner.type': 'Biznes turi',
    'partner.volume': 'Oylik xarid hajmi',
    'partner.comment': 'Izoh',
    'partner.send': 'Ariza yuborish',
    'partner.sending': 'Yuborilmoqda…',
    'partner.doneTitle': 'Arizangiz qabul qilindi',
    'partner.doneText': 'Mutaxassisimiz tez orada siz bilan bog‘lanadi.',
    'blog.empty': 'Yangi maqolalar tez orada joylanadi.',
    'faq.empty': 'Savollar va javoblar tez orada joylanadi.',
  },
  ru: {
    'nav.catalog': 'Товары',
    'nav.new': 'Новинки',
    ...
    'partner.title': 'Станьте партнёром ALIVER',
    'partner.subtitle': 'Оставьте заявку на оптовые закупки, дилерство или корпоративные заказы.',
    'partner.company': 'Компания',
    'partner.person': 'Контактное лицо',
    'partner.phone': 'Телефон',
    'partner.telegram': 'Telegram',
    'partner.city': 'Город',
    'partner.type': 'Тип бизнеса',
    'partner.volume': 'Месячный объём закупок',
    'partner.comment': 'Комментарий',
    'partner.send': 'Отправить заявку',
    'partner.sending': 'Отправка…',
    'partner.doneTitle': 'Ваша заявка принята',
    'partner.doneText': 'Наш специалист скоро свяжется с вами.',
    'blog.empty': 'Новые статьи появятся в ближайшее время.',
    'faq.empty': 'Вопросы и ответы появятся в ближайшее время.',
  },
} as const;
